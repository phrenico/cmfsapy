"""This script generates Fig2.pdf
...
gen_and_measure = False  # if True, then generates dimension measurements and save it into Figure03_data.pkl
...
if gen_and_measure:
    ...
    with open("Figure03_data.pkl", 'wb') as f:
        pickle.dump(id_m_dict, f)
else:
    with open("Figure03_data.pkl", 'rb') as f:
