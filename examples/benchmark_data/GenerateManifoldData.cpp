		 ...
		 int nrhs, const mxArray *prhs[])
{
  ...
  if(data_set < 0 || data_set>13) { mexPrintf("Dataset has to be between 0 and 12 !"); return; }
  if(dim <= 0) { mexPrintf("Dimension has to be larger than 0 !"); return; }
  if(num <= 0) { mexPrintf("The number of points has to be larger than 0 !"); return; }
  ...
  switch(data_set)
  {
    case 0:  //generates a (slightly distorted) sinusoid over the circle in R^3
      ...
      radii=new double[long(num)];
      phi  =new double[long(num)];
      ...
      mexPrintf("Generated %i data points of a sinusoid on the circle in R^3\n",num);
      mexPrintf("The correct dimension of this submanifold is 1\n");
     ...
     case 1:  // generates a k-sphere  (uniformly sampled)
      ...
      mexPrintf("Generated %i data points of a dim-1 - dimensional sphere in R^dim\n",num);
      mexPrintf("The correct dimension of this submanifold is %i\n",dim-1);
    ...
    case 2: // generatesa 3d affine space in 5 dimensions
      ...
      para1=new double[long(num)];
      para2=new double[long(num)];
      para3=new double[long(num)];
      ...
      mexPrintf("Generated %i data points of a 3-dimensional affine subspace in R^5\n",num);
      mexPrintf("The correct dimension of this submanifold is 3\n");
    ...
    case 3: // generates a strange 4-dim figure in 6 dimensions
      ...
      mexPrintf("Generated %i data points of a 4-dimensional strange submanifold in R^6\n",num);
      mexPrintf("The correct dimension of this submanifold is 4\n");
     ...
     case 4: // generates a 4-dim manifold in 8 dimensions
      ...
      data = mxGetPr(plhs[0]);
       ...
       mexPrintf("Generated %i data points of a 4-dimensional  submanifold in R^8\n",num);
       mexPrintf("The correct dimension of this submanifold is 4\n");
     ...
     case 5: // generates a 2d helix in 3d
      ...
      mexPrintf("Generated %i data points of a 2-dimensional helix in R^3\n",num);
      mexPrintf("The correct dimension of this submanifold is 2\n");
    ...
    case 6: // generates a 6-dim manifold in 36- dimensions
       ...
       mexPrintf("Generated %i data points of a 6-dimensional strange submanifold in R^36\n",num);
       mexPrintf("The correct dimension of this submanifold is 6\n");
    ...
    case 7: //swiss roll
      ...
      mexPrintf("Generated %i data points of the swiss roll in R^3\n",num);
      mexPrintf("The correct dimension of this submanifold is 2\n");
    ...
    case 8: // generates a 12-dim  in 72- dimensions
       ...
       mexPrintf("Generated %i data points of a 12-dimensional strange submanifold in R^72\n",num);
       mexPrintf("The correct dimension of this submanifold is 12\n");
    ...
    case 10: // generates a k-hypercube
      ...
      mexPrintf("Generated %i data points of a dim-1 dimensional hypercube R^dim\n",num);
      mexPrintf("The correct dimension of this submanifold is %i\n",dim-1);
    ...
    case 11: //generates a moebius-band in 3d
      ...
      mexPrintf("Generated %i data points of a 10 times tisted moebius strip in R^3\n",num);
      mexPrintf("The correct dimension of this submanifold is 2\n");
    ...
    case 12: // generate a multivariate Gaussian
      ...
      mexPrintf("Generated %i data points of a dim dimensional Gaussian distribution with unit variance in R^dim\n",num);
      mexPrintf("The correct dimension of this submanifold is %i\n",dim);
    ...
    case 13:  //generates a one-dimensional curve in dim dimensions
      ...
      mexPrintf("Generated %i data points of a curve in R^dim\n",num);
      mexPrintf("The correct dimension of this submanifold is 1\n");
      delete phi;
      break;
